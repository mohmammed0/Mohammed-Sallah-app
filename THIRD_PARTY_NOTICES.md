...
Principal notices: Expo, React/React Native, Next.js, Turborepo, TanStack Query, React Hook Form, Zod, i18next, Vitest, React Native Testing Library, noble-hashes, and UUID are MIT-licensed. Supabase platform/CLI, Playwright, OpenAI Node, and Maestro are Apache-2.0 (individual Supabase JS packages are MIT). These licenses include warranty disclaimers and require preservation of notices where applicable.
