...
- M2 لفحص الوسائط **مكتمل في المستودع وHosted CI** عند
  `03c35255514f4a2aba008a86912eaf38b0029eca` في Draft PR #26. نُشرت مخططات ودوال Preview، لكن
  مضيف الماسح الخاص ما زال **HUMAN INPUT REQUIRED**.
- المسار المحلي يفك ترميز JPEG/PNG/WebP ويعيد ترميزها، ويطبق Remux فعلياً ومحدوداً على
  ...
  وليس CDR.
- اكتملت مسارات العميل ومقدم الخدمة وAI والصوت والترجمة وPush في المستودع، ونجح OpenAI محلياً
  بستة طلبات اصطناعية. مشروع Supabase Preview يحمل الترحيلات ودوال Edge الحالية، لكن جلسة إدارة
  الأسرار غير متاحة، لذلك بقي OpenAI وPush والماسح في Preview مغلقين بأمان.
- تنظيف عناصر الفحص وجدولة Push مثبتان في Preview ويقرآن Vault فقط؛ قيم Vault الخارجية لم تُضف.
- المسار Android-first، لكن حساب EAS ومفتاح Maps المقيد واعتمادات Push والتوقيع والجهاز الفعلي
  **HUMAN INPUT REQUIRED**، ولم يبدأ build.
