...
- تجهيز الكود وGitHub قبل الإطلاق في [PR #36](https://github.com/mohmammed0/Mohammed-Sallah-app/pull/36)
  إلى `main` مباشرة، مع حفظ تاريخ PR #33 وPR #35. تشترط [بوابة ما قبل الإطلاق](../release/PRELAUNCH.md)
  نجاح وظائف CI الست: منها تصدير Android وiOS، ورحلة HTTP مع تفعيل الموافقة، وحزمة تحقق
  المصدر والترحيلات والحزم. مرجع النتيجة الحالية هو رأس الطلب وتشغيل CI المطابق له.
- نجح `pnpm validate` لنقطة التطبيق السابقة `de2b64813a7e61682d86f3528393d85c0f81dddb`
  في ٦٣١ اختبارًا، مع تخطٍ واحد موثق خاص بـWindows؛ يبقى هذا العدد دليلاً تاريخيًا محدد النطاق.
