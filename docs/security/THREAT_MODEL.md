...
| Provider document/upload abuse | private quarantine, signature checks, re-encode, scan gate, cleanup audit | External production scanner and region require deployment  |
